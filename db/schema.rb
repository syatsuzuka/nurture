...
ActiveRecord::Schema.define(version: 2022_07_19_132622) do
  ...
  create_table "target_templates", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "parent_id"
    t.index ["parent_id"], name: "index_target_templates_on_parent_id"
  ...
  create_table "targets", force: :cascade do |t|
    ...
    t.bigint "parent_id"
    t.string "score_type", default: "float"
  ...
  add_foreign_key "target_templates", "target_templates", column: "parent_id"
